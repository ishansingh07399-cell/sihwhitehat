...
export default function TimelineView({ analysisData }) {
  ...
  // Generate a plausible timeline based on the extracted entities and edges
  const timelineEvents = [];
  const baseTime = Date.now();
  
  // Event 1: Initial Intelligence Report
  timelineEvents.push({
    id: 'e1',
  ...
  // Event 2: Key Suspects Identified
  ...
  // Event 3: Communications intercepted
  ...
  // Event 5: Algorithmic Legal flagging
  ...
  // Event 6: Today - Network synthesis
  timelineEvents.push({
    id: 'e6',
